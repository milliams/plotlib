...
impl Representation for Scatter {
    ...
    fn to_svg(
        ...
        svg_render::draw_face_points(&self.data, x_axis, y_axis, face_width, face_height, &self.style)
    }
    ...
    fn to_text(
        ...
        text_render::render_face_points(&self.data, x_axis, y_axis, face_width, face_height, &self.style)
    }
}
